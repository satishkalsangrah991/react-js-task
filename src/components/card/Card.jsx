...
const Card = () => {
  ...
  const handlePageClick = (pageNumber) => {
    dispatch({ type: "card/setPage", payload: pageNumber });
  };
      ...
      pageNumbers.push(
        <button
          ...
          className={`p-2 rounded-lg ${
            page === i ? "bg-blue-700 text-white" : "bg-blue-500 text-white"
          }`}
        >
          {i}
        </button>
            ...
            <div className="flex flex-col">
              ...
              <div className="flex justify-center my-6 bg-white shadow-lg p-4 rounded-lg">
                ...
                <label
                  ...
                  className="toggle relative inline-block h-12 w-24 cursor-pointer overflow-clip rounded-full border border-sky-300 bg-sky-300 transition-colors duration-200 peer-checked:border-sky-800 peer-checked:bg-sky-800"
                >
                  {/* Toggle Switch Handler */}
                  <span className="toggle-handler relative left-0 top-0 z-1 inline-block h-6 w-6 -rotate-45 rounded-full bg-amber-300 shadow transition-all duration-[400ms]"></span>
                  <span className="sr-only">toggle switch</span>
                </label>
              </div>
              <div className="bg-white px-2 py-4 shadow-xl rounded-lg">
                <h1 className="text-xl py-2 text-center font-bold">
                  Feedback?
                </h1>
                <div className="flex justify-center">
                  <button
                    className="bg-green-500 text-white font-bold px-4 py-2 shadow-lg rounded-md my-2"
                    onClick={handleOpenModal}
                  >
                    We're Listening
                  </button>
